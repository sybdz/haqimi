...
@Composable
fun TtsCustomHeaders(headers: List<TtsCustomHeader>, onUpdate: (List<TtsCustomHeader>) -> Unit) {
    Column(
        ...
        Button(
            onClick = {
                val updatedHeaders = headers.toMutableList()
                updatedHeaders.add(TtsCustomHeader("", ""))
                onUpdate(updatedHeaders)
            },
            modifier = Modifier.fillMaxWidth()
        ) {
...
@Composable
fun TtsCustomBodies(customBodies: List<TtsCustomBody>, onUpdate: (List<TtsCustomBody>) -> Unit) {
    ...
    Column(
        ...
        Button(
            onClick = {
                val updatedBodies = customBodies.toMutableList()
                updatedBodies.add(TtsCustomBody("", JsonPrimitive("")))
                onUpdate(updatedBodies)
            },
            modifier = Modifier.fillMaxWidth()
        ) {
