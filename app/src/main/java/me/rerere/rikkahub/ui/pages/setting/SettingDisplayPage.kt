...
//            }
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(R.string.setting_display_page_enable_html_rendering_title))
                    },
                    supportingContent = {
                        Text(stringResource(R.string.setting_display_page_enable_html_rendering_desc))
                    },
                    trailingContent = {
                        Switch(
                            checked = displaySetting.enableHtmlRendering,
                            onCheckedChange = {
                                updateDisplaySetting(displaySetting.copy(enableHtmlRendering = it))
                            }
                        )
                    },
                )
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(R.string.setting_display_page_enable_svg_rendering_title))
                    },
                    supportingContent = {
                        Text(stringResource(R.string.setting_display_page_enable_svg_rendering_desc))
                    },
                    trailingContent = {
                        Switch(
                            checked = displaySetting.enableSvgRendering,
                            onCheckedChange = {
                                updateDisplaySetting(displaySetting.copy(enableSvgRendering = it))
                            }
                        )
                    },
                )
